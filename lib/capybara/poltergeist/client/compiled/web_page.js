...
Poltergeist.WebPage = (function() {
  ...
  WebPage.prototype.onResourceErrorNative = function(errorResponse) {
    ...
    system.stderr.writeLine('  - unable to load url: "' + errorResponse.url + '"');
    system.stderr.writeLine('  - error code: ' + errorResponse.errorCode + ', description: ' + errorResponse.errorString );
